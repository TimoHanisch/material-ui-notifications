...
class Store extends EventEmitter {
    ...
    _addNotification(notification) {
        ...
        this._notifications = [tmpNotification, ...this._notifications];
        if (autoHide) {
            ...
            this._timerRefs = [
                ...this._timerRefs,
                {
                    ...
                    ref: setTimeout(() => {
                        this._removeNotification(tmpNotification.id);
                    }, autoHide),
                },
            ];
        }
    ...
    _removeNotification(notificationId) {
        ...
        this._timerRefs = this._timerRefs.filter(
            refObj => refObj.id !== notificationId
        );
        this.emit(DISPATCH_UPDATE);
    }
